...
| Causal-AI accuracy | **90.9%** rule-based, CI-gated (≥85% overall, ≥95% playbook) | [CAUSAL_EVAL.md](CAUSAL_EVAL.md) |
...
Since then, per-pillar enhancements in [docs/enhancements/](docs/enhancements/):
...
| Document | What it is |
| --- | --- |
| [SYSTEM_ARCHITECTURE.md](SYSTEM_ARCHITECTURE.md) | Component and data-flow reference |
| [ROAD_TO_100.md](ROAD_TO_100.md) | The delivered-work record — what shipped and why |
| [docs/enhancements/](docs/enhancements/) | Per-feature specs (*what*) + implementation plans (*how*) |
...
| [CAUSAL_EVAL.md](CAUSAL_EVAL.md) | Causal-AI accuracy scoring and thresholds |
